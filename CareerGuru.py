...
ANS_QUES_MAP = {
        ...
        "I am CareerGuru,I am hear to help you with your carrer,Type Start Test to begain the test": ["who are you", "what is your identity", "what is your name"],
...
def main():
    ...
    st.write("Hi! I'm CareerGuru, your personal career counseling bot. Ask your queries in the text box below and hit enter. If and when you are ready to take our personality test, type \"start my test\" and you're good to go!")


    query = get_text()
    if (query==""):
        ans = "Hi, I'm CareerGuru. \nHow can I help you?"
        st.text_area("CareerGuru:", value=ans, height=100, max_chars=None)
        speak(ans)
